...
export const EditPromptPage: React.FC = () => {
  ...
  const fetchPrompt = async () => {
    ...
    try {
      ...
      // Auto-detect placeholders for the existing prompt
      const placeholders = extractPlaceholders(prompt.prompt);
      const errors = validatePromptText(prompt.prompt);
  ...
  return (
    <Box>
      ...
      <Typography variant="subtitle1" color="text.secondary" sx={{ mb: 4 }}>
        Make changes to your prompt and update your library
      </Typography>
